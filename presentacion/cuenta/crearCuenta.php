...
if (isset($_POST["registrarCuenta"])) {
    ...
    if (!$apartamento->tienePropietario($idApartamento)) {
        $mensajeError = "El apartamento no tiene propietario asignado. No se puede registrar la cuenta.";
    } else {
...
if (isset($_POST["nombreApartamento"]) && !isset($_POST["registrarCuenta"])) {
    ...
    if ($datosApartamento) {
        ...
        $cantidadAPagar = $saldoAnterior + $cuotaAdministracion + $valorArriendo;
    }
}
            ...
            <div class="card-body">
                ...
                <?php if ($datosApartamento): ?>
                    ...
                    <form method="post" action="">
                        ...
                        <input type="hidden" name="idAdmin" value="<?php echo htmlspecialchars($id); ?>">
                        ...
                        <?php if ($datosApartamento->getPropietario() === null): ?>
                            <div class="alert alert-danger mt-3">
                                Este apartamento no tiene propietario asignado. No se puede registrar la cuenta.
                            </div>
                        <?php elseif ($cuentaExiste): ?>
                            <div class="alert alert-danger mt-3">
