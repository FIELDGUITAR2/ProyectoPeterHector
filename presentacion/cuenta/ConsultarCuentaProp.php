...
<div class="container mt-4">
    ...
    <?php } else { ?>
        <form method="post" action="presentacion/cuenta/ConsultarCuentaProp.php">
            ...
            <a href="presentacion/pdf.php" target="_blank" class="btn btn-danger"><i class="fas fa-file-pdf"></i>PDF</a>
        </form>
    <?php } ?>
